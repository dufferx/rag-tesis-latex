...
\autor{Mario Antonio Martinez Villatoro}{M}{carreraUno} % Autor 1
\autor{Rodrigo Andrés Mena Caballero}{M}{carreraUno} % Autor 2 (opcional)
\autor{Duglas Fernando Pineda Fuentes}{M}{carreraUno} % Autor 3 (opcional)
