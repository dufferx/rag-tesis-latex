...
\newcommand{\resumen}{
El diagnóstico y mantenimiento de sistemas de aire acondicionado tipo Split exige el acceso oportuno a información técnica altamente especializada. En la práctica, esta información se encuentra distribuida en manuales de servicio extensos que pueden superar las 150 páginas, lo que obliga al técnico a invertir en promedio entre uno y cinco minutos por consulta en búsquedas manuales, afectando directamente su productividad. Las entrevistas realizadas a tres profesionales del sector con experiencia de entre seis meses y tres años y medio evidenciaron que las herramientas de inteligencia artificial genéricas, aunque valoradas positivamente, presentan una limitante crítica: generan respuestas superficiales y descontextualizadas respecto al fabricante, lo que puede derivar en diagnósticos erróneos y en riesgos operativos reales para el técnico y el equipo intervenido. Esta brecha tecnológica entre la inmediatez que el campo exige y la exactitud que los manuales de servicio oficiales demandan constituye el problema central que motiva el presente trabajo.

En respuesta a dicha problemática, el presente proyecto se propuso diseñar e implementar un prototipo funcional de asistente de diagnóstico basado en la arquitectura de Generación Aumentada por Recuperación (RAG), orientado exclusivamente al dominio de los aires acondicionados tipo Split residenciales y comerciales ligeros con rangos de capacidad de 9,000 a 24,000 BTU, tanto en tecnología Inverter como No-Inverter. El dominio operativo del sistema se delimitó a diecinueve fallas comunes documentadas en manuales de servicio oficiales de múltiples fabricantes. El desarrollo siguió la metodología CRISP-DM, estructurando el proceso en seis fases iterativas: comprensión del dominio, comprensión y curación de los datos, preparación del corpus documental, modelado del \textit{pipeline} RAG, evaluación técnica y evaluación con usuarios finales, e implementación del prototipo con interfaz de usuario.

Los fundamentos teóricos del sistema, abordados en el Capítulo 3, se sustentan en cuatro pilares conceptuales interrelacionados: el Procesamiento de Lenguaje Natural (PLN) como base para interpretar consultas en lenguaje coloquial técnico; los Modelos de Lenguaje de Gran Escala (LLM) basados en la arquitectura Transformer, cuya limitación estructural de alucinación justifica precisamente la adopción del enfoque RAG; la representación semántica de textos mediante \textit{embeddings} y bases de datos vectoriales para la recuperación por similitud; y el \textit{framework} LlamaIndex como capa de integración que orquesta el ciclo completo de ingesta, recuperación y generación.

El Capítulo 4 documenta las decisiones técnicas adoptadas a lo largo del proceso de modelado. La evaluación empírica del formato de ingesta demostró que el PDF nativo supera al texto plano pre-extraído en la preservación de la integridad semántica de las fichas diagnósticas, alcanzando el 100\,\% de integridad en los cinco códigos de error evaluados frente al 0--20\,\% obtenido con texto plano. En el \textit{benchmarking} de modelos de \textit{embeddings}, el modelo Gemini Embedding 001 de Google obtuvo una tasa de recuperación (\textit{hit rate}) del 80\,\%, representando una mejora de 60 puntos porcentuales sobre los mejores modelos de código abierto evaluados, cuya incapacidad de mapeo semántico entre el español de las consultas y el inglés técnico de los manuales los descalificó para este dominio bilingüe. Como modelo generativo se seleccionó Gemini 1.5 Pro con temperatura de 0.1, y como estrategias de síntesis de respuesta se adoptaron los modos \textit{tree\_summarize} para consultas de diagnóstico multi-paso y \textit{compact} para búsquedas directas de código de error. La interfaz de usuario desarrollada incorpora gestión de sesiones con historial independiente por usuario, garantizando el aislamiento del contexto conversacional entre evaluadores.

La evaluación del prototipo, presentada en el Capítulo 5, comprendió cinco sesiones con técnicos activos del sector que emplearon manuales reales de los fabricantes Daikin, Mabe y Toshiba. El 100\,\% de los participantes logró completar el flujo de carga de manual y consulta sin errores técnicos visibles, y calificó el tiempo de espera durante la indexación como aceptable. En la verificación funcional, el 93\,\% de las quince preguntas específicas formuladas fue evaluado como correcto y completo por los propios técnicos, y el sistema alcanzó una tasa de citación explícita del manual fuente del 87\,\%. El análisis crítico del instrumento de evaluación identificó un caso de polarización en la comprensión de consultas, con cuatro usuarios en el nivel máximo de acuerdo y uno en el máximo desacuerdo, atribuible al empleo de lenguaje excesivamente coloquial y sin contexto técnico por parte de dicho participante. Adicionalmente, se documentaron tres limitaciones operativas de alto valor ingenieril: la dependencia de cuota de API de pago (Tier~1) para mantener tiempos de indexación aceptables y la degradación potencial del rendimiento bajo restricciones de la capa gratuita o ante cargas masivas concurrentes; una alucinación por transferencia de dominio en la que el sistema generó con confianza un procedimiento técnico para un equipo VRF de 10 toneladas, fuera del catálogo del manual cargado, constituyendo el único caso reprobado con alucinación confirmada; y la incapacidad del sistema para interpretar o referenciar el contenido visual de los diagramas eléctricos y de tuberías embebidos en los manuales, derivada de la arquitectura puramente textual del \textit{pipeline}.

Se concluye que el prototipo implementado cumple los objetivos planteados: el sistema genera diagnósticos fundamentados exclusivamente en los manuales de servicio oficiales, con plena trazabilidad documental, y reduce el tiempo de búsqueda del técnico de entre uno y cinco minutos a entre dos y diez segundos según la complejidad de la consulta. La validación empírica con usuarios finales confirma la utilidad, la precisión percibida y la estabilidad operativa del sistema en condiciones reales de uso. Con base en las limitaciones documentadas, se plantean tres líneas de trabajo futuro prioritarias: la integración de modelos de lenguaje multimodales nativos que permitan razonar sobre el contenido visual de los diagramas embebidos, superando la actual dependencia de descripciones textuales parciales; la implementación de un mecanismo de preguntas de retroalimentación interactiva que oriente al técnico hacia consultas más estructuradas cuando la formulación inicial resulte demasiado ambigua para una recuperación semántica precisa; y el desarrollo de \textit{guardrails} de seguridad como capa de validación previa a la generación, destinados a bloquear las alucinaciones por transferencia de dominio ante consultas sobre equipos que no están cubiertos por el manual fuente activo.
}
...
El Capítulo 5, Presentación, Análisis e Interpretación de Resultados, expone los hallazgos obtenidos durante la fase de evaluación del prototipo. Se presentan los resultados de la evaluación con cinco técnicos usuarios mediante un instrumento Likert estructurado, la verificación funcional de casos de uso representativos del trabajo en campo, y el análisis crítico de las limitaciones operativas y casos borde identificados durante las pruebas.

El Capítulo 6, Conclusiones y Recomendaciones, sintetiza los principales logros del proyecto en relación con los objetivos planteados y propone líneas de trabajo futuro sustentadas en bibliografía científica, entre ellas la integración de modelos multimodales, la implementación de preguntas de retroalimentación interactiva y el desarrollo de \textit{guardrails} de seguridad para prevenir alucinaciones por transferencia de dominio.

Finalmente, el documento incluye tres anexos: el Anexo A contiene el catálogo exhaustivo de las diecinueve fallas documentadas que conforman el dominio del sistema; el Anexo B presenta el instrumento de entrevista y las transcripciones de las entrevistas realizadas a los técnicos durante la fase de comprensión del problema; y el Anexo C documenta el diseño final de la interfaz de usuario del prototipo mediante capturas de pantalla de los módulos implementados.
...
Se diseñó e implementó con éxito el prototipo funcional del asistente de diagnóstico basado en la arquitectura de Generación Aumentada por Recuperación (RAG) para aires acondicionados tipo Split. El sistema integra manuales de servicio oficiales de múltiples fabricantes como fuente exclusiva de conocimiento, lo que supera directamente la limitación identificada en la fase de comprensión del problema: la dependencia de fuentes genéricas no contextualizadas que generaban diagnósticos superficiales e imprecisos. Para ello se definió un catálogo operativo de diecinueve fallas comunes como dominio del sistema, se construyó el repositorio documental curado a partir de manuales técnicos oficiales y se diseñó el flujo conversacional del asistente a partir del análisis del proceso real de diagnóstico de los técnicos del sector. La interfaz de usuario desarrollada permitió que el 100\,\% de los participantes completara el flujo completo de carga de manual y consulta sin errores técnicos visibles durante ninguna de las cinco sesiones de evaluación.

Se demostró que la arquitectura RAG habilita la generación de recomendaciones diagnósticas fundamentadas \textit{exclusivamente} en los fragmentos recuperados de los documentos técnicos oficiales cargados por el usuario, reduciendo la ambigüedad característica de los modelos de lenguaje generalistas. En las pruebas funcionales, el sistema alcanzó una tasa de citación explícita de la fuente documental en el 87\,\% de las preguntas específicas evaluadas. En el instrumento de evaluación, cuatro de cinco usuarios (80\,\%) manifestaron acuerdo respecto a que las respuestas parecieron estar basadas en el manual cargado; el participante restante registró desacuerdo total, en coherencia con las consultas excesivamente coloquiales documentadas en la Sección~5.1.3. Esta capacidad de trazabilidad documental distingue al prototipo de las herramientas genéricas identificadas en el planteamiento del problema, las cuales carecen del contexto técnico específico del fabricante y generan respuestas redundantes sin referencia a la documentación de origen.
