...
% Corrige el nombre global de los epígrafes sin modificar la plantilla protegida.
% Se aplica al iniciar el documento para prevalecer sobre la configuración de main.tex.
\AtBeginDocument{\captionsetup[figure]{name=Figura}}
...
\autor{Mario Antonio Martinez Villatoro}{H}{carreraUno} % Autor 1
\autor{Rodrigo Andrés Mena Caballero}{H}{carreraUno} % Autor 2 (opcional)
\autor{Duglas Fernando Pineda Fuentes}{H}{carreraUno} % Autor 3 (opcional)
\autor{}{}{} % Autor 4 (opcional)

\newcommand{\mesdegraduacion}{Octubre 2026} % Mes y año de graduación
...
\vspace*{-2.5cm}
\centering
\makebox[\linewidth][c]{\includegraphics[scale=0.44]{img/diagrama1.png}}
\caption{Arquitectura del Sistema de Generación Aumentada por Recuperación (RAG). Fuente: [Elaboración propia]}
\label{fig:diagrama1.png}
\end{figure}
...
La arquitectura definitiva del prototipo integra la interfaz web implementada con React (versión 19.2.4) y Vite (versión 8.0.1), el backend desarrollado con FastAPI (versión 0.115.12), el motor de ingesta, la base vectorial, la capa de persistencia local y los servicios externos de Gemini consumidos mediante Google GenAI SDK (versión 1.73.1). Dada la extensión del diagrama, se presenta en dos vistas complementarias que conservan la continuidad del flujo mediante las conexiones etiquetadas \textit{BackgroundTasks} y \textit{consulta RAG}. La primera vista, mostrada en la \reffig{diagrama2-a.jpg}, corresponde a las capas de interacción con el usuario (frontend SPA) y de orquestación en el backend, donde se observa el flujo de peticiones desde el navegador del técnico hacia la API y el servidor de archivos estáticos.

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{img/diagrama2-a.jpg}
\caption[Arquitectura Final del Sistema RAG para diagnóstico de HVAC. Vista 1: capas de usuario y backend]{Arquitectura Final del Sistema RAG para diagnóstico de HVAC. Vista 1: capas de usuario y backend. Fuente: [Elaboración propia]}
\label{fig:diagrama2-a.jpg}
\end{figure}

La segunda vista, presentada en la \reffig{diagrama2-b.jpg}, detalla el motor de recuperación aumentada (ingesta y consulta RAG), la capa de persistencia local (SQLite, imágenes extraídas, manuales PDF e índice vectorial ChromaDB) y los servicios externos de Gemini en la nube. En conjunto, ambas vistas permiten observar el flujo completo entre la consulta del técnico, la recuperación documental, la generación de respuestas fundamentadas y la entrega de evidencias visuales asociadas al manual consultado.

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{img/diagrama2-b.jpg}
\caption[Arquitectura Final del Sistema RAG para diagnóstico de HVAC. Vista 2: motor RAG, persistencia y servicios externos]{Arquitectura Final del Sistema RAG para diagnóstico de HVAC. Vista 2: motor RAG, persistencia y servicios externos. Fuente: [Elaboración propia]}
\label{fig:diagrama2-b.jpg}
\end{figure}
...
% =========================================================
\tabla{V}{
  \begin{longtable}{|p{6.8cm}|C{1.2cm}|C{1.2cm}|C{1.2cm}|C{1.2cm}|C{1.2cm}|}
    ...
    \hline
    \multicolumn{6}{p{14.6cm}}{\footnotesize\textit{Nota:} MDA~=~Muy de acuerdo; LDA~=~Ligeramente de acuerdo; N~=~Neutral; LDE~=~Ligeramente en desacuerdo; MDE~=~Muy en desacuerdo.}\\
    \multicolumn{6}{p{14.6cm}}{\footnotesize Fuente: Elaboración propia (2026), basada en instrumento de evaluación aplicado a cinco técnicos HVAC.}\\
  \end{longtable}
}
...
\newcommand{\anexos}{
    ...
    \anexo{Catálogo de Fallas Comunes en Aires Acondicionados tipo Split}{
        \tabla{V}{
          \begingroup
          \renewcommand{\thetable}{\Alph{anexosletra}.\arabic{table}}
          \setcounter{table}{0}
          \captionsetup{list=no}
          \begin{longtable}{|p{7.5cm}|p{7.5cm}|}
            \caption{Catálogo de fallas comunes en aires acondicionados tipo Split}\label{tab:anexoA_catalogo_fallas}\\
            \hline
            ...
            \hline
            \multicolumn{2}{l}{\small Fuente: Elaboración propia (2026), con base en manuales de servicio de los fabricantes analizados.} \\
          \end{longtable}
          \endgroup
        }
    }
